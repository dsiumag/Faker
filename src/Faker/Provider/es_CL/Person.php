...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $firstNameMale = array(
        'Aaron', 'Adam', 'Adrian', 'Alberto', 'Aleix', 'Alejandro', 'Alex', 'Alonso', 'Alvaro', 'Andres',
        'Angel', 'Antonio', 'Bruno', 'Carlos', 'Cesar', 'Cristian', 'Daniel', 'Dario', 'David', 'Domingo',
        'Diego', 'Eduardo', 'Enrique', 'Eric', 'Fernando', 'Francisco', 'Gabriel', 'Gonzalo',
        'Guillermo', 'Hector', 'Hugo', 'Ian', 'Ignacio', 'Isaac', 'Ismael', 'Ivan', 'Jaime',
        'Javier', 'Jesus', 'Joel', 'Jorge', 'Jose', 'Juan', 'Leonardo', 'Leandro', 'Leonardo', 'Lucas', 'Luis',
        'Manuel', 'Marcelo', 'Marco', 'Marcos', 'Mario', 'Martin', 'Mateo', 'Matias', 'Miguel',
        'Nicolas', 'Omar', 'Osvaldo', 'Oscar', 'Pablo', 'Pedro', 'Rafael', 'Raul', 'Rene',
        'Roberto', 'Rodrigo', 'Ruben', 'Samuel', 'Santiago', 'Saul', 'Sergio', 'Sebastian', 'Victor',
    );


    protected static $firstNameFemale = array(
        'Adriana', 'Antonia', 'Alba', 'Alejandra', 'Alicia','Ana', 'Andrea', 'Angela','Angelica',
        'Beatriz', 'Berta', 'Blanca', 'Candela','Carla', 'Carmen', 'Carolina','Catalina', 'Clara',
        'Claudia', 'Cristina', 'Daniela', 'Diana', 'Elena', 'Elsa','Emilia', 'Erica', 'Eva', 'Florencia', 'Francisca'
        'Gabriela', 'Helena', 'Ines', 'Irene', 'Isabel', 'Isidora', 'Javiera', 'Jimena', 'Julia', 'Laura', 'Leyla',
        'Lidia', 'Lucia', 'Luna', 'Luisa', 'Manuela', 'Marcela','Marcia', 'Maria', 'Mariana', 'Marta', 'Martina',
        'Miriam', 'Nadia', 'Natalia','Noelia', 'Olivia', 'Pamela','Paola', 'Patricia', 'Paula','Raquel', 'Rocio','Sandra',
        'Sara', 'Silvia', 'Sofia', 'Teresa', 'Valentina', 'Valeria', 'Victoria', 'Yasna', 'Yazmin', 'Zulema',
    );
